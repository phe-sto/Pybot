...
class TahomaBeeTest(unittest.TestCase, Auto):
    def kill_scrcpy(self):
        ...
        # Kill scrcpy
        while exists("1525701181175.png") is not None:
    ...
    def close_app(self):
        ...
        while exists("1525695903814.png") is None:
            if self.check_click("1525682405778.png", after_click="1525683200318.png") is True:
                sleep(2)
            if exists("1525695903814.png") is not None:
                break
            if self.check_click("1525682363441.png", after_click="1525683447606.png") is True:
                sleep(2)
    ...
    def test_A_clean_app(self):
        ...
        # Fullscreen
        rightClick("1525685897078.png")
        click("1525685943369.png")
        rightClick()
        # Unlock the phone if needed
        if exists("1525682278715.png") is not None:
            dragDrop("1525682278715.png", "1525682325573.png")
        # Clean the application that might be open on the target device
        self.close_app()
        # Access the app screen
        click("1525685342870.png")
        assert exists("1525683094268.png") is not None

    def test_B_open_TahomaBee(self):
        "Start the TahomaBee application"
        self.check_click("1525683094268.png")
        self.check_click("1525683073786.png")
        sleep(15)
        assert exists("1525683551858.png") is not None or exists(
            "1525683633286.png") is not None

    def test_C_connexion(self):
        "Connection test to the TahomaBee with Florian Kowalski Credentials"
        if exists("1525683551858.png") is None:
            # Enter the credentials and connect the application
            paste("1525697538725.png", 'florian.kowalski')
            sleep(0.5)
            paste("1525696983510.png", 'connex01')
            sleep(0.5)
            click("1525697121889.png")
            sleep(15)
        else:
            # Already connected
            pass
        assert exists("1525683551858.png") is not None

    def test_Z_leave_app(self):
        "Test to kill scrcpy process after closing all apps"
        # Clean the application that might be open on the target device
        self.close_app()
        assert exists("1525683551858.png") is None and exists(
            "1525683633286.png") is None
        self.kill_scrcpy()
        assert exists("1525701181175.png") is None

    def test_D_motor_connected_up_down_up(self):
        "Test that a motor is accessible"
        assert exists("1525706502609.png") is not None
        self.check_click("1525706502609.png")
        assert exists("1525706982307.png") is not None
        self.check_click("1525707172817.png")
        sleep(5)
        self.check_click("1525707172817.png")
        dragDrop("1525707221915.png", "1525707234856.png")
        self.check_click("1525707501652.png")
        sleep(30)
        self.check_click("1525707462863.png")

        assert exists("1525708156426.png") is not None
        self.check_click("1525707172817.png")
        sleep(5)
        self.check_click("1525707172817.png")
        self.check_click("1525707501652.png")
    ...
    def test_E_motor_unconnected_up_down_up(self):
        ...
        assert exists("1525706544677.png") is not None
        self.check_click("1525706544677.png")
        assert exists("1525706982307.png") is not None
        self.check_click("1525707172817.png")
        sleep(5)
        self.check_click("1525707172817.png")
        ...
        assert exists("1525708156426.png") is None
        self.check_click("1525708554886.png")
        assert exists("1525706544677.png")

    def test_F_configuration(self):
        "Test Access to configuration"
        self.check_click("1525708768155.png")
        assert exists("1525708801293.png") is not None
        self.check_click("1525708801293.png")
        assert exists("1525708858247.png") is not None
